					...
					<div class="layout-control-group">
						...
						<div class="layout-controls">
							<input type="text" class="layout-span12" id="ux_tooltip_control_<?php echo $dynamicId; ?>" 
								placeholder="<?php _e( "Enter Tooltip Text", contact_bank ); ?>" 
						...
						<div class="layout-controls" style="padding-top:5px;">
							...
							if(isset($form_settings[$dynamicId]["cb_checkbox_alpha_filter"]))
							{
								if($form_settings[$dynamicId]["cb_checkbox_alpha_filter"] == "1")
								{
									...
									<input type="checkbox" checked="checked" value="1" 
										id="ux_checkbox_alpha_filter_<?php echo $dynamicId; ?>" 
							...
							if(isset($form_settings[$dynamicId]["cb_ux_checkbox_alpha_num_filter"]))
							{
								if($form_settings[$dynamicId]["cb_ux_checkbox_alpha_num_filter"] == "1")
								{
									?>
									<input type="checkbox" checked="checked" value="1"  
										id="ux_checkbox_alpha_num_filter_<?php echo $dynamicId; ?>" 
										name="ux_checkbox_alpha_num_filter_<?php echo $dynamicId; ?>" />
							...
							{
								?>
								<input type="checkbox"  value="0"  id="ux_checkbox_digit_filter_<?php echo $dynamicId; ?>" 
									name="ux_checkbox_digit_filter_<?php echo $dynamicId; ?>"  value="Digits" />
								<span class="rdl"><?php _e( "Digits", contact_bank ); ?></span>
							<?php
							}
