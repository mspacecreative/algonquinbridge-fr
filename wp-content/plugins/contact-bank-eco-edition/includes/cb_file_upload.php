...
?>
<form id="ux_frm_file_upload_control" action="#" method="post" class="layout-form">
    <div class="fluid-layout">
        <div class="layout-span12">
            <div class="widget-layout">
                <div class="widget-layout-title">
                    <h4><?php _e( "File Upload", contact_bank ); ?></h4>
                </div>
				<div class="widget-layout-body">
					<div class="layout-control-group">
						...
						<div class="layout-controls">
							<input type="text" class="layout-span12" id="ux_label_text_<?php echo $dynamicId; ?>" 
								placeholder="<?php _e( "Enter Label", contact_bank ); ?>" onkeyup="enter_admin_label(<?php echo $dynamicId; ?>);" 
								value="<?php echo isset($form_settings[$dynamicId]["cb_label_value"])  ? $form_settings[$dynamicId]["cb_label_value"] :  _e( "File Upload", contact_bank ); ?>"  
					...
					<div class="layout-control-group">
						...
						<div class="layout-controls">
							<input type="text" class="layout-span12" 
								...
								id="ux_tooltip_control_<?php echo $dynamicId; ?>" placeholder="<?php _e( "Enter Tooltip", contact_bank ); ?>" 
					...
					<div class="layout-control-group">
						...
						<div class="layout-controls">
							<input  class="layout-span12"type="text" 
								value="<?php echo isset($form_settings[$dynamicId]["cb_admin_label"])  ? $form_settings[$dynamicId]["cb_admin_label"] :  _e( "File Upload", contact_bank ); ?>" 
								id="ux_admin_label_<?php echo $dynamicId; ?>" placeholder="<?php _e( "Enter Admin Label", contact_bank ); ?>" name="ux_admin_label_<?php echo $dynamicId; ?>" />
						</div>
					</div>
					<div class="layout-control-group">
					...
					<div class="layout-control-group">
						...
						<div class="layout-controls">
							<?php
	                            if(isset($form_settings[$dynamicId]["cb_allow_multiple_file"]))
	                            {
	                                if($form_settings[$dynamicId]["cb_allow_multiple_file"] == "1")
	                                {
	                                ?>
	                                    <input type="checkbox" checked="checked"  id="ux_allow_multiple_file_<?php echo $dynamicId; ?>" 
	                                    	name="ux_allow_multiple_file_<?php echo $dynamicId; ?>" style="margin-top: 10px;" value="1">
	                                <?php
	                                }
	                                else
	                                {
	                                ?>
	                                    <input type="checkbox" id="ux_allow_multiple_file_<?php echo $dynamicId; ?>" 
	                                    	name="ux_allow_multiple_file_<?php echo $dynamicId; ?>" style="margin-top: 10px;" value="0">
	                                <?php
	                                }
	                            }
	                            else
					...
					<div class="layout-control-group">
						...
						<div class="layout-controls">
							<input class="layout-span12" type="text" 
								placeholder="<?php _e( "Enter File Extensions", contact_bank ); ?>" 
								id="ux_allowed_file_extensions_<?php echo $dynamicId; ?>" name="ux_allowed_file_extensions_<?php echo $dynamicId; ?>" 
								value="<?php 
								if(isset($form_settings[$dynamicId]["cb_allow_file_ext_upload"]))
								{
									$file_ext = str_replace("*.", "", $form_settings[$dynamicId]["cb_allow_file_ext_upload"]);
									echo $final_extensions = str_replace(";", ",", $file_ext);
								}
								else 
								{
									echo $final_extensions = "jpg,jpeg,png,gif,zip";
								}
								
								?>"
								 />
							<br />
 							<span style="margin-top: 5px;"><?php _e( "The file extensions must be separated with comma(',')", contact_bank ); ?></span>
						</div>
					</div>
					<div class="layout-control-group">	
						<label class="layout-control-label"><?php _e( "Allowed File Size", contact_bank ); ?> :</label>
						<div class="layout-controls">
							<input class="layout-span12" type="text" id="ux_maximum_file_allowed_<?php echo $dynamicId; ?>" 
								name="ux_maximum_file_allowed_<?php echo $dynamicId; ?>" 
								value="<?php echo isset($form_settings[$dynamicId]["cb_maximum_file_allowed"]) ? $form_settings[$dynamicId]["cb_maximum_file_allowed"] : "10"; ?>" />
							<br />
							<p style="margin-top: 5px;"><?php _e( "File Size must be in Mb", contact_bank ); ?></p>
						</div>
					</div>
...
<script type="text/javascript">
	...
	jQuery("#ux_frm_file_upload_control").validate
	({
		submitHandler: function(form)
		{
			jQuery.post(ajaxurl, jQuery(form).serialize() + "&controlId="+controlId+"&form_id="+form_id+"&form_settings="+JSON.stringify(<?php echo json_encode($form_settings); ?>)+"&event=update&param=save_file_upload_control&action=add_contact_form_library", function(data)
			{
