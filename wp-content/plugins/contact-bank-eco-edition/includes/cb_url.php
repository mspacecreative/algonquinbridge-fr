...
?>
<form id="ux_frm_url_control" action="#" method="post" class="layout-form">
	<div class="fluid-layout">
		<div class="layout-span12">
			<div class="widget-layout">
				<div class="widget-layout-title">
					<h4><?php _e( "Website / URL", contact_bank ); ?></h4>
				</div>
				<div class="widget-layout-body">
						...
						<div class="layout-controls" style="margin-top:7px;">
							<?php
								...
								else
								{
									...
									<input type="radio" id="ux_required_<?php echo $dynamicId; ?>" 
										checked="checked" name="ux_required_control_radio_<?php echo $dynamicId; ?>" value="0" />
									<label style="vertical-align: text-bottom;">
										<?php _e( "Not Required", contact_bank ); ?>
									</label>
									<?php
					...
					<div class="layout-control-group">
						...
						<div class="layout-controls">
							...
							placeholder="<?php _e( "Place Holder", contact_bank ); ?>"  
					...
					<div class="layout-control-group">
						...
						<div class="layout-controls">
							<input type="text" placeholder="<?php _e( "Enter Admin Label", contact_bank ); ?>" 
								...
								class="layout-span12" id="ux_admin_label_<?php echo $dynamicId; ?>" 
...
<script type="text/javascript">
	...
	jQuery("#ux_frm_url_control").validate
	({
		submitHandler: function(form)
		{
			jQuery.post(ajaxurl, jQuery(form).serialize() + "&controlId="+controlId+"&form_id="+form_id+"&form_settings="+JSON.stringify(<?php echo json_encode($form_settings) ?>)+"&event=update&param=save_url_control&action=add_contact_form_library", function(data)
			{
				...
				jQuery("#ux_txt_url_control_"+dynamicId).attr("placeholder",jQuery("#ux_default_value_"+dynamicId).val());
