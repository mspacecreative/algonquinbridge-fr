            ...
            <div class="widget-layout">
                ...
                <div class="widget-layout-body">
                    ...
                    <div class="layout-control-group">
                        ...
                        <div class="layout-controls">
                            <input placeholder="<?php _e( "Enter Tooltip", contact_bank);?>" type="text" 
                    ...
                    <div class="layout-control-group">
                        ...
                        <div class="layout-controls" style="padding-top:5px;">
                            ...
                            if(isset($form_settings[$dynamicId]["cb_checkbox_alpha_filter"]))
                            {
                                ...
                                {
                                    ?>
                                    <input type="checkbox" checked="checked" id="ux_checkbox_alpha_filter_<?php echo $dynamicId; ?>" 
                                    	name="ux_checkbox_alpha_filter_<?php echo $dynamicId; ?>" value="1" />
                            ...
                            if(isset($form_settings[$dynamicId]["cb_checkbox_strip_tag_filter"]))
                            {
                                ...
                                {
                                    ?>
                                    <input type="checkbox"  value="0"  id="ux_checkbox_strip_tag_filter_<?php echo $dynamicId; ?>" 
                                    	name="ux_checkbox_strip_tag_filter_<?php echo $dynamicId; ?>"  value="Strip Tags" />
                                    <span class="rdl"><?php _e( "Strip Tags", contact_bank ); ?></span>
                                <?php
                                }
                            }
                            ...
                            if(isset($form_settings[$dynamicId]["cb_checkbox_trim_filter"]))
                            {
                                ...
                                {
                                    ?>
                                    <input type="checkbox" checked="checked"  value="1" id="ux_checkbox_trim_filter_<?php echo $dynamicId; ?>" 
                                    	name="ux_checkbox_trim_filter_<?php echo $dynamicId; ?>"  value="Trim" />
                                ...
                                {
                                    ?>
                                    <input type="checkbox" value="0" id="ux_checkbox_trim_filter_<?php echo $dynamicId; ?>" 
                                    	name="ux_checkbox_trim_filter_<?php echo $dynamicId; ?>"  value="Trim" />
                                    <span class="rdl"><?php _e( "Trim", contact_bank ); ?></span>
                                <?php
                                }
