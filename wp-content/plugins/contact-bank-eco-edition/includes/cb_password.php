...
?>
<form id="ux_frm_password_control" action="#" method="post" class="layout-form">
	<div class="fluid-layout">
		<div class="layout-span12">
			<div class="widget-layout">
				<div class="widget-layout-title">
					<h4><?php _e( "Password", contact_bank ); ?></h4>
				</div>
				<div class="widget-layout-body">
					<div class="layout-control-group">
						...
						<div class="layout-controls">
							<input type="text" class="layout-span12" onkeyup="enter_admin_label(<?php echo $dynamicId; ?>);" 
								value="<?php echo isset($form_settings[$dynamicId]["cb_label_value"])  ? $form_settings[$dynamicId]["cb_label_value"] :  _e( "Password", contact_bank ); ?>" 
					...
					<div class="layout-control-group">
						...
						<div class="layout-controls">
							<textarea class="layout-span12" id="ux_description_control_<?php echo $dynamicId; ?>"  placeholder="<?php _e( "Enter Description", contact_bank ); ?>" 
					...
					<div class="layout-control-group">
						...
						<div class="layout-controls">
							<input type="text" class="layout-span12" id="ux_tooltip_control_<?php echo $dynamicId; ?>" 
								placeholder="<?php _e( "Enter Tooltip", contact_bank ); ?>" name="ux_tooltip_control_<?php echo $dynamicId; ?>" 
								value="<?php echo isset($form_settings[$dynamicId]["cb_tooltip_txt"]) ? $form_settings[$dynamicId]["cb_tooltip_txt"] : ""; ?>" />
						</div>
						<input type="hidden" id="tooltip_txt_hidden_value_<?php echo $dynamicId; ?>" 
							name="tooltip_txt_hidden_value_<?php echo $dynamicId; ?>" />
					</div>
					<div class="layout-control-group">
						...
						<div class="layout-controls">
							<input type="text" class="layout-span12"  id="ux_admin_label_<?php echo $dynamicId; ?>" 
								placeholder="<?php _e( "Enter Admin Label", contact_bank ); ?>" name="ux_admin_label_<?php echo $dynamicId; ?>" 
					...
					<div class="layout-control-group">
						...
						<div class="layout-controls" style="margin-top:10px;">
							<?php
							if(isset($form_settings[$dynamicId]["cb_checkbox_alpha_filter"]))
							{
								if($form_settings[$dynamicId]["cb_checkbox_alpha_filter"] == "1")
								{
									?>
									<input type="checkbox" checked="checked" value="1" id="ux_checkbox_alpha_filter_<?php echo $dynamicId; ?>"
										 name="ux_checkbox_alpha_filter_<?php echo $dynamicId; ?>"/>
								...
								{
									?>
									<input type="checkbox" value="0" id="ux_checkbox_alpha_filter_<?php echo $dynamicId; ?>" 
										name="ux_checkbox_alpha_filter_<?php echo $dynamicId; ?>"/>
						 			<span class="rdl"><?php _e( "Alpha", contact_bank ); ?></span>
								<?php
								}
							...
							if(isset($form_settings[$dynamicId]["cb_ux_checkbox_alpha_num_filter"]))
							{
								if($form_settings[$dynamicId]["cb_ux_checkbox_alpha_num_filter"] == "1")
								{
									?>
									<input type="checkbox" checked="checked" id="ux_checkbox_alpha_num_filter_<?php echo $dynamicId; ?>" 
										name="ux_checkbox_alpha_num_filter_<?php echo $dynamicId; ?>"  value="1" />
								...
								{
									?>
									<input type="checkbox" id="ux_checkbox_alpha_num_filter_<?php echo $dynamicId; ?>" 
										name="ux_checkbox_alpha_num_filter_<?php echo $dynamicId; ?>"  value="0"/>
									<span class="rdl"><?php _e( "Alpha Numeric", contact_bank ); ?></span>
								<?php
								}
							}
							...
							if(isset($form_settings[$dynamicId]["cb_checkbox_digit_filter"]))
							{
								if($form_settings[$dynamicId]["cb_checkbox_digit_filter"] == "1")
								{
									?>
									<input type="checkbox" checked="checked" id="ux_checkbox_digit_filter_<?php echo $dynamicId; ?>" 
										name="ux_checkbox_digit_filter_<?php echo $dynamicId; ?>" value="1" />
								...
								{
									?>
									<input type="checkbox" id="ux_checkbox_digit_filter_<?php echo $dynamicId; ?>" 
										name="ux_checkbox_digit_filter_<?php echo $dynamicId; ?>"  value="0" />
									<span class="rdl"><?php _e( "Digits", contact_bank ); ?></span>
									<?php
								}
							}
							...
							if(isset($form_settings[$dynamicId]["cb_checkbox_strip_tag_filter"]))
							{
								if($form_settings[$dynamicId]["cb_checkbox_strip_tag_filter"] == "1")
								{
									?>
									<input type="checkbox" checked="checked" id="ux_checkbox_strip_tag_filter_<?php echo $dynamicId; ?>" 
										name="ux_checkbox_strip_tag_filter_<?php echo $dynamicId; ?>"  value="1" />
								...
								{
									?>
									<input type="checkbox" id="ux_checkbox_strip_tag_filter_<?php echo $dynamicId; ?>" 
										name="ux_checkbox_strip_tag_filter_<?php echo $dynamicId; ?>"  value="0" />
									<span class="rdl"><?php _e( "Strip Tags", contact_bank ); ?></span>
								<?php
								}
							}
							...
							if(isset($form_settings[$dynamicId]["cb_checkbox_trim_filter"]))
							{
								if($form_settings[$dynamicId]["cb_checkbox_trim_filter"] == "1")
								{
									?>
									<input type="checkbox" checked="checked" id="ux_checkbox_trim_filter_<?php echo $dynamicId; ?>" 
										name="ux_checkbox_trim_filter_<?php echo $dynamicId; ?>"  value="1" />
								...
								{
									?>
									<input type="checkbox" id="ux_checkbox_trim_filter_<?php echo $dynamicId; ?>" 
										name="ux_checkbox_trim_filter_<?php echo $dynamicId; ?>" value="0" />
									<span class="rdl"><?php _e( "Trim", contact_bank ); ?></span>
								<?php
								}
							}
...
<script type="text/javascript">
	...
	jQuery("#ux_frm_password_control").validate
	({
		submitHandler: function(form)
		{
			jQuery.post(ajaxurl, jQuery(form).serialize() + "&controlId="+controlId+"&form_id="+form_id+"&form_settings="+JSON.stringify(<?php echo json_encode($form_settings) ?>)+"&event=update&param=save_password_control&action=add_contact_form_library", function(data)
			{
