...
?>
<form id="ux_frm_address_control" action="#" method="post" class="layout-form">
	<div class="fluid-layout">
		<div class="layout-span12">
			<div class="widget-layout">
				<div class="widget-layout-title">
					<h4><?php _e( "Address", contact_bank ); ?></h4>
				</div>
				<div class="widget-layout-body">
					...
					<div class="layout-control-group">
						...
						<div class="layout-controls">
							<textarea id="ux_description_control_<?php echo $dynamicId; ?>" class="layout-span12" placeholder="<?php _e( "Enter Description", contact_bank ); ?>" name="ux_description_control_<?php echo $dynamicId; ?>"><?php echo isset($form_settings[$dynamicId]["cb_description"]) ? $form_settings[$dynamicId]["cb_description"] : ""; ?></textarea>
						</div>
					</div>
					<div class="layout-control-group">
					...
					<div class="layout-control-group">
						...
						<div class="layout-controls">
							<input type="text" class="layout-span12" id="ux_tooltip_control_<?php echo $dynamicId; ?>" value="<?php echo isset($form_settings[$dynamicId]["cb_tooltip_txt"]) ? $form_settings[$dynamicId]["cb_tooltip_txt"] : ""; ?>" placeholder="<?php _e( "Enter Tooltip Text", contact_bank ); ?>" name="ux_tooltip_control_<?php echo $dynamicId; ?>"/>
						</div>
					</div>
					<div class="layout-control-group">
						<label class="layout-control-label"><?php _e( "Place Holder", contact_bank ); ?> :</label>
						<div class="layout-controls">
							<input type="text" class="layout-span12" id="ux_default_value_<?php echo $dynamicId; ?>" value="<?php echo isset($form_settings[$dynamicId]["cb_default_txt_val"]) ? $form_settings[$dynamicId]["cb_default_txt_val"] : ""; ?>"  placeholder="<?php _e( "Enter Place Holder", contact_bank ); ?>"  name="ux_default_value_<?php echo $dynamicId; ?>"/>
						</div>
					</div>
					<div class="layout-control-group">
						<label class="layout-control-label"><?php _e( "Admin Label", contact_bank ); ?> :</label>
						<div class="layout-controls">
							<input type="text" placeholder="<?php _e( "Enter Admin Label", contact_bank ); ?>" value="<?php echo isset($form_settings[$dynamicId]["cb_admin_label"])  ? $form_settings[$dynamicId]["cb_admin_label"] :  _e( "Untitled", contact_bank ); ?>" class="layout-span12" id="ux_admin_label_<?php echo $dynamicId; ?>" name="ux_admin_label_<?php echo $dynamicId; ?>"/>
						</div>
					</div>
					<div class="layout-control-group">
...
jQuery("#ux_frm_address_control").validate
({
	submitHandler: function(form)
	{
		jQuery.post(ajaxurl, jQuery(form).serialize() + "&controlId="+controlId+"&form_id="+form_id+"&form_settings="+JSON.stringify(<?php echo json_encode($form_settings) ?>)+"&event=update&param=save_address_control&action=add_contact_form_library", function(data)
		{
			...
			jQuery("#ux_address_control_"+dynamicId).attr("placeholder",jQuery("#ux_default_value_"+dynamicId).val());
