...
?>
<form id="ux_frm_name_control" action="#" method="post" class="layout-form">
	<div class="fluid-layout">
		<div class="layout-span12">
			<div class="widget-layout">
				<div class="widget-layout-title">
					<h4><?php _e( "Name", contact_bank ); ?></h4>
				</div>
				<div class="widget-layout-body">
					...
					<div class="layout-control-group">
						...
						<div class="layout-controls">
							<input type="text" class="layout-span12" id="ux_tooltip_control_<?php echo $dynamicId; ?>" placeholder="<?php _e( "Enter Tooltip Text", contact_bank ); ?>" name="ux_tooltip_control_<?php echo $dynamicId; ?>" value="<?php echo isset($form_settings[$dynamicId]["cb_tooltip_txt"]) ? $form_settings[$dynamicId]["cb_tooltip_txt"] : ""; ?>"/>
						</div>
					</div>
					<div class="layout-control-group">
						<label class="layout-control-label"><?php _e( "Place Holder", contact_bank ); ?> :</label>
						<div class="layout-controls">
							<input type="text" class="layout-span12" id="ux_default_value_<?php echo $dynamicId; ?>" placeholder="<?php _e( "Enter Place Holder", contact_bank ); ?>"  name="ux_default_value_<?php echo $dynamicId; ?>" value="<?php echo isset($form_settings[$dynamicId]["cb_default_txt_val"]) ? $form_settings[$dynamicId]["cb_default_txt_val"] : ""; ?>"/>
						</div>
					</div>
					<div class="layout-control-group">
...
<script type="text/javascript">
	...
	jQuery("#ux_frm_name_control").validate
	({
		submitHandler: function(form)
		{
			jQuery.post(ajaxurl, jQuery(form).serialize() + "&controlId="+controlId+"&form_id="+form_id+"&form_settings="+JSON.stringify(<?php echo json_encode($form_settings) ?>)+"&event=update&param=save_name_control&action=add_contact_form_library", function(data)
			{
				...
				jQuery("#ux_txt_name_control_"+dynamicId).attr("placeholder",jQuery("#ux_default_value_"+dynamicId).val());
