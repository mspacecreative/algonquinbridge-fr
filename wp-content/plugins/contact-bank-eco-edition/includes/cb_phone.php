...
?>
<form id="ux_frm_phone_control" action="#" method="post" class="layout-form">
	<div class="fluid-layout">
		<div class="layout-span12">
			<div class="widget-layout">
				<div class="widget-layout-title">
					<h4><?php _e( "Phone", contact_bank ); ?></h4>
				</div>
					...
					<div class="layout-control-group">
						...
						<div class="layout-controls">
							<input type="text" class="layout-span12" 
								...
								id="ux_default_value_<?php echo $dynamicId; ?>" placeholder="<?php _e( "Enter Place Holder", contact_bank ); ?>"  
...
<script type="text/javascript">
	...
	jQuery("#ux_frm_phone_control").validate
	({
		submitHandler: function(form)
		{
			jQuery.post(ajaxurl, jQuery(form).serialize() + "&controlId="+controlId+"&form_id="+form_id+"&form_settings="+JSON.stringify(<?php echo json_encode($form_settings) ?>)+"&event=update&param=save_phone_control&action=add_contact_form_library", function(data)
			{
				...
				jQuery("#ux_txt_phone_control_"+dynamicId).attr("placeholder",jQuery("#ux_default_value_"+dynamicId).val());
