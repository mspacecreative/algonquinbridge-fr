		...
		<div class="layout-span12">
			<div class="widget-layout">
				<div class="widget-layout-title">
					<h4><?php _e( "Global Settings", contact_bank ); ?></h4>
				</div>
				<div class="widget-layout-body">
					<a class="btn btn-info" href="admin.php?page=dashboard"><?php _e("Back to Dashboard", contact_bank);?></a>
					<a class="btn btn-danger" href="#" onclick="restore_global_settings();"><?php _e("Restore Global Settings", contact_bank); ?>
					</a>
					...
					<div id="form_success_message" class="message green" style="display: none;">
						<span>
							<strong><?php _e("Global Settings Saved. Kindly wait for the redirect.", contact_bank); ?></strong>
						</span>
					</div>
					...
					<div class="fluid-layout">
						<div class="layout-span6">
							<div class="widget-layout">
								<div class="widget-layout-title">
									<h4><?php _e( "Label Settings", contact_bank ); ?></h4>
									<span class="tools">
							...
							<div class="widget-layout">
								<div class="widget-layout-title">
									<h4><?php _e( "Input Field Settings", contact_bank ); ?></h4>
									<span class="tools">
						...
						<div class="layout-span6">
							<div class="widget-layout">
								<div class="widget-layout-title">
								 	<h4><?php _e( "Submit Button Settings", contact_bank ); ?></h4>
								 	<span class="tools">
							...
							<div class="widget-layout">
								<div class="widget-layout-title">
									<h4><?php _e( "Success Message Settings", contact_bank ); ?></h4>
									<span class="tools">
							...
							<div class="widget-layout">
								<div class="widget-layout-title">
									<h4><?php _e( "Error Message Settings", contact_bank ); ?></h4>
									<span class="tools">
...
jQuery("#ux_frm_form_settings").validate
({
	rules: 
	{
		ux_ddl_select_form :
		...
		ux_ddl_font_family_input_field :
		{
			required : true
		},
		ux_clr_text_color_input_field :
		{
			required : true
		},
		ux_ddl_font_style_input_field :
		{
			required : true
		},
		ux_txt_font_size_input_field :
		{
			required : true
		},
		ux_txt_border_radius_input_field :
		{
			required : true
		},
		ux_clr_border_color_input_field :
		{
			required : true
		},
		ux_txt_border_size_input_field :
		{
			required : true
		},
		ux_ddl_border_style_input_field :
		{
			required : true
		},
		
		ux_clr_bg_color_input_field :
		{
			required : true
		},
		ux_rdl_radio_button :
		...
		ux_txt_text_submit_button :
		{
			required : true
		},
		ux_ddl_font_style_submit_button :
		{
			required : true
		},
		ux_ddl_font_size_submit_button :
		{
			required : true
		},
		ux_txt_button_width_submit_button :
		{
			required : true
		},
		ux_clr_bg_color_submit_button :
		{
			required : true
		},
		ux_clr_hover_bg_color_submit_button :
		{
			required : true
		},
		ux_clr_text_color_submit_button :
		{
			required : true
		},
		ux_clr_border_color_submit_button :
		{
			required : true
		},
		ux_clr_border_size_submit_button :
		{
			required : true
		},
		ux_txt_border_radius_submit_button :
		{
			required : true
		},
		ux_ddl_font_family_success_msg :
		{
			required : true
		},
		ux_ddl_font_size_success_msg :
		{
			required : true
		},
		ux_clr_bg_color_success_msg :
		{
			required : true
		},
		ux_clr_border_color_success_msg :
		{
			required : true
		},
		ux_clr_text_color_success_msg :
		{
			required : true
		},
		ux_ddl_font_family_error_msg :
		{
			required : true
		},
		ux_ddl_font_size_error_msg :
		{
			required : true
		},
		ux_clr_bg_color_error_msg :
		{
			required : true
		},
		ux_clr_border_color_error_msg :
	...
	{
	    if(jQuery(element).attr("id") == "ux_txt_border_radius_input_field" || jQuery(element).attr("id") == "ux_txt_border_size_input_field" || jQuery(element).attr("id") == "ux_txt_text_submit_button"|| jQuery(element).attr("id") == "ux_txt_button_width_submit_button" || jQuery(element).attr("id") == "ux_clr_border_size_submit_button" || jQuery(element).attr("id") == "ux_txt_border_radius_submit_button")
	    {
	...
	submitHandler: function(form)
	{
		...
		jQuery.post(ajaxurl, jQuery(form).serialize() +"&form_id="+form_id+"&param=submit_form_settings&action=layout_settings_contact_library", function(data)
		{
			setTimeout(function()
			{
...
function restore_global_settings() {
	var form_id = jQuery("#ux_ddl_select_form").val();
	var restore = confirm("<?php _e( "Are you sure, you want to Restore Global Settings?", contact_bank ); ?>");
	if (restore == true) 
	{
		jQuery.post(ajaxurl, "form_id="+form_id+"&param=restore_global_setting&action=layout_settings_contact_library", function (data) {
		location.reload();
		});
	}
}
