		...
		<div class="layout-span12">
			<div class="widget-layout">
				...
				<div class="widget-layout-body">
							...
							<div class="widget-layout">
								...
								<div class="widget-layout-body">
									...
									<div class="layout-control-group">
										...
										{
											?>
										<button type="button" class="btn btn-info button_space" onclick="create_control(17);">
							 				<i class=" icon-lock"></i> <?php _e("Captcha", contact_bank); ?>
										</button>
										<?php
										}
										?>
					...
					<input type="hidden" id="hidden_captcha_count" name="hidden_captcha_count" value="0" />
					<div class="separator-doubled"></div>
					<input class="btn btn-info layout-span2" type="submit" id="submit_button" name="submit_button" style="margin-top: 10px;" value="<?php _e("Save Form", contact_bank); ?>"/>
				</div>
			</div>
		</div>
	</div>
...
jQuery(document).ready(function(){
	var captcha_count = jQuery("#hidden_captcha_count").val();
	if(captcha_count > 0)
	{
