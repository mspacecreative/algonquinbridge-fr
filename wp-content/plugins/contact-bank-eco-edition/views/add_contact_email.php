...
switch ($cb_role)
{
	case "administrator":
		...
		{
			?>
			jQuery("#ux_txt_name").attr("readonly","readonly");
			jQuery("input[type=radio][name=ux_rdl_send_to]").attr("disabled",true);
			jQuery("#ux_txt_email").attr("readonly","readonly");
			jQuery("#ux_txt_from_name").attr("readonly","readonly");
			jQuery("#ux_txt_from_email").attr("readonly","readonly");
			jQuery("#ux_txt_reply_to").attr("readonly","readonly");
			jQuery("#ux_txt_cc").attr("readonly","readonly");
			jQuery("#ux_txt_bcc").attr("readonly","readonly");
			jQuery("#ux_txt_subject").attr("readonly","readonly");
			//jQuery("#uxEmailTemplate").attr("disabled", "disabled");
			jQuery("#ux_ddl_send_to_field").attr("disabled","disabled");
			jQuery("#ux_ddl_from_name").attr("disabled","disabled");
			jQuery("#ux_ddl_from_email").attr("disabled","disabled");
			jQuery("#ux_ddl_reply_to").attr("disabled","disabled");
			jQuery("#ux_ddl_cc").attr("disabled","disabled");
			jQuery("#ux_ddl_bcc").attr("disabled","disabled");
			jQuery("#ux_ddl_subject").attr("disabled","disabled");
			jQuery("#ux_ddl_message").attr("disabled","disabled");
			<?php
		}
	break;
	case "editor":
